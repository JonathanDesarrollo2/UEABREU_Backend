...
export class BillingService {
  ...
  public static async getCurrentBCVRate(): Promise<number> {
    ...
    try {
      ...
      console.error("Error obteniendo tasa BCV, usando respaldo 45:", error);
      return 45;
    }
  }
  ...
  static async applyInscriptionFeesWithTransaction(
    studentId: string,
  ...
  // En src/services/billingServices.ts
// Reemplaza el método applyMonthlyFee por este:
    ...
    static async applyMonthlyFee() {
        ...
        // ✅ MODIFICACIÓN: Incluir repitiente y condicionado, excluir pendiente e inactivo
